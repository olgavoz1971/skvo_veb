...
@callback(
    Output('periodogram_ls_option_collapse', 'is_open'),
    Output('periodogram_bls_option_collapse', 'is_open'),
    Input('method_tess_lc_switch', 'value')
)
...
@callback(
    ...
    state=dict(
        ...
        nyquist_factor=State('nyquist_factor', 'value'),
        normalization=State('pg_normalization_parameter', 'value'),
        frequency_factor=State('pg_frequency_factor', 'value')
    ),
    background=background_callback,
    ...
    prevent_initial_call=True)
def periodogram(n_clicks, js_lightcurve, period_freq, method, nterms, oversample,
...
# State('tess_lc_select_period_dropdown', 'value'),

@callback(Output('period_tess_lc_input', 'value', allow_duplicate=True),
          Input('tess_lc_select_period_dropdown', 'value'),
