...
Instead of fitting a fixed function (e.g. parabola), it builds a **smooth probabilistic model** of 
the data using a **Gaussian Process (GP)**.  
...
from skvo_veb.utils.gp import (GUESS_SIGMA, LEN_MIN,
                               read_lc, load_intervals, add_flux,
                               select_jd_interval, gp_peak_pipeline, guess_length_scale,
