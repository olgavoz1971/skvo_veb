...
# Using ThreadPool instead of multiprocessing.Pool because Celery worker
# processes (handling my Dash Plotly background callbacks) are daemonic
# and cannot spawn child processes
...
class SkyPatrolClient:
    ...
    def _get_curves(
        ...
        with ThreadPool(processes=threads) as pool:	# olgavoz
